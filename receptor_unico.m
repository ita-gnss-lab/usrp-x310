...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
addpath('C:\Users\pande\Desktop\receptor_refletometria\generate_reference');
addpath('C:\Users\pande\Desktop\receptor_refletometria\read_data');
addpath('C:\Users\pande\Desktop\receptor_refletometria\CA_acquisition');
...
index_sample_in=1;
tt = 400e-3;
threshold_CH1=tt*num_noncoh_periods;   %1.2e3*num_noncoh_periods;
threshold_CH2=tt*num_noncoh_periods;   %1.2e3*num_noncoh_periods
...
for k=1:1800
    ...
    x_CH1 = (total_acq(index_sample_in:index_sample_in+N-1,2))';
    ...
    if k<=num_noncoh_periods
        ...
        sats_found_CH12 = sats_found_CH1 %intersect(sats_found_CH1, sats_found_CH2);
        sats_found_CH1 = sats_found_CH12;
        fprintf("Sats found both channels: \n");
        disp(sats_found_CH12);
        % Check the order: 
        if ~(isequal(sats_found_CH12, sats_found_CH1) )
